 ...
 * Class: CMSC 203 CRN 21456
 * Description: Utility class to aid the functioning of Random Number Guesser
 */
...
public class RNG {
	 ...
	 */
	public static int rand(int num) {//parameter has been added as the provided code does not match with assignment instructions. 
